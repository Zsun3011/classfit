...
const PostDetail = ({ post, onClose, onDelete, onEdit, onCommentAdd   }) => {
        ...
        <div className="PostDetail-container">
            <div className="PostDetail-topsection">
                <div className="NewPost-title">
                    ...
                    <div className="PostDetail-buttons">
                        <button type="button" className="modify-button" onClick={handleEdit}>수정</button>
                        <button type="button" className="remove-button" onClick={handleDelete}>삭제</button>
                    </div>
                </div>
            ...
            <div className="PostDetail-submit">
                <input
                        ...
                        onKeyPress={handleKeyPress} //엔터 키
